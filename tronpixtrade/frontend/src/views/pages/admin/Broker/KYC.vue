...
const loadKyc = async () => {
  loading.value = true
  try {
    const res = await api.get('/users?type=broker')
...
const approveKYC = async () => {
  ...
  try {
    await api.post(`/admin/users/${selectedUser.value.id}/kyc/approve`)
...
const rejectKYC = async () => {
  ...
  actionLoading.value = true
  try {
    await api.post(`/admin/users/${selectedUser.value.id}/kyc/reject`)
...
const deleteKYC = async (id: number) => {
  ...
  try {
    await api.post(`/admin/users/${id}/kyc/delete`)
